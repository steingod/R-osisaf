...
function() {
    ...
    file <-
	"/home/steingod/software/osisaf/support/complmlhl/stathourlyssi.txt"
    ...
    file <-
	"/home/steingod/software/osisaf/support/complmlhl/stathourlydli.txt"
    ddh <- scan(file,
	    what=list(n=integer(0),
		year=integer(0),month=integer(0),day=integer(0),
		hour=integer(0),minute=integer(0),
		...
		skip=3,na.strings="-99.00")
    file <-
	"/home/steingod/software/osisaf/support/complmlhl/statdaylissi.txt"
    dsd <- scan(file,
	    what=list(n=integer(0),
		year=integer(0),month=integer(0),day=integer(0),
		hour=integer(0),minute=integer(0),
		...
		skip=3,na.strings="-99.00")
    file <-
	"/home/steingod/software/osisaf/support/complmlhl/statdaylidli.txt"
    ddd <- scan(file,
	    what=list(n=integer(0),
		year=integer(0),month=integer(0),day=integer(0),
		hour=integer(0),minute=integer(0),
